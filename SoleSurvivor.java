...
public class SoleSurvivor {
   ...
   public static void intro() throws FileNotFoundException { //introduction phrase and character creator
      ...
      map = mapCreate(player);
   }
   public static void playing() { //code run while playing game, uses other methods
